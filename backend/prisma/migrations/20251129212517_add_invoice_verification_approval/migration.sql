...
INSERT INTO "new_Invoice" ("balanceDue", "createdAt", "createdById", "customerId", "date", "dueDate", "id", "invoiceNumber", "journalEntryId", "notes", "paidAmount", "reference", "status", "subtotal", "taxAmount", "total", "updatedAt") SELECT "balanceDue", "createdAt", "createdById", "customerId", "date", "dueDate", "id", "invoiceNumber", "journalEntryId", "notes", "paidAmount", "reference", "status", "subtotal", "taxAmount", "total", "updatedAt" FROM "Invoice";
DROP TABLE "Invoice";
